...
import NecromancerDisplay from "../components/features/unit/NecromancerDisplay";
    ...
    necromancer: {
        ...
        returnDisplay(item: any) {
            return (
                ...
                <ErrorBoundary fallback={<div>Something went wrong with DisplayPageStatic.tsx</div>}>
                    <GenericDisplay  d_colour={item.Colour} d_name={item.Name} d_type={""} d_method={() => <NecromancerDisplay data={item} />}/>
                </ErrorBoundary>
            )
        },
        returnFilterSelect(manager : FilterManager, update : NoneToNoneFunction, close : NoneToNoneFunction) {
